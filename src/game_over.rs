...
impl GameOver {
    ...
    pub unsafe fn render(
        ...
        let score_model = translation(self.screen_width / 2.0 - score_width / 2.0, y - 65.0, 0.0)
    ...
    pub fn handle_click(&self, mouse_x: f32, mouse_y: f32, audio: &AudioSystem) -> GameOverAction {
